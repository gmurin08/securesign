...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'SecureSign - Share' },
    { description: 'I just signed a document with SecureSign!' },
    {
      property: 'og:title',
    ...
    },
    {
      ...
      content: 'I just signed with SecureSign!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Redirect to home for non-QR share links
  throw redirect('/');
};
